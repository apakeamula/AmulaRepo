 ...
 @Entity
 @Table(name = "GIRO_TABLE", catalog = "", schema = "CUSTOM")
 @IdClass(giroEmbed.class)
 @XmlRootElement
 @NamedQueries({
    @javax.persistence.NamedQuery(name = "GiroTbl.findOne", query = "SELECT r FROM GiroTbl r where r.payref = :payref and r.serialnum = :serialnum")})
 public class GiroTbl
