 ...
 public class GiroTblJpaControllerNaps  {
     private static final Logger logFile = Logger.getLogger(GiroTblJpaControllerNaps.class);
     ...
     public void persistGiro(RiaDtlTbl neft)
         ...
         try  {
             ...
             logFile.info("Giro Naps Insert " + sysdate.toString());
             ...
             //neft.getTransferreason() + "','" + "RIA/" + neft.getOrderno() + "/" + neft.getPin() + "
            ...
            logFile.info("Print Query -- " + que);
             ...
             logFile.error("GiroTblJpaControllerNaps Error " + e.toString());
